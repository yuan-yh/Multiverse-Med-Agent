...
// import Logo from '@/public/Seagull-by-Rones.svg';
  ...
  return (
    <nav className="flex w-full items-center justify-between border-t border-b border-neutral-200 px-4 py-4 dark:border-neutral-800">
      <div className="flex items-center gap-2">
        <div className="size-7 rounded-full bg-gradient-to-br from-green-300 to-blue-700" />
        <h1 className="text-base font-bold md:text-2xl">Medi-Verse</h1>
      </div>
      <UserButton />
    </nav>
  );
